    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (apqpoints >= 100) {
                    cm.sendNext("哇，看起来你已经准备好所需要的#b100#k点数了，我们来交易吧！");
                ...
                cm.sendOk("主要目标是让玩家在战斗竞技场中积累点数，以便兑换最高奖品：#z3010018#。在战斗中积累点数，当时机成熟时与我交谈以获取奖品。在每场战斗中，玩家有机会根据最终拥有的珠宝数量来获得积分。但要小心！如果你的积分与其他玩家的差距#r太大#k，那一切都将化为乌有，你只能获得微薄的#r1分#k。");
                cm.dispose();
            }
        } else if (status == 2) {
