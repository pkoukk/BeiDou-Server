...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("什么是辅助剂?","制造战士武器","制造弓箭手武器","制造法师武器","制造飞侠武器",
            "使用辅助剂制造战士武器","使用辅助剂制造弓箭手武器","使用辅助剂制造法师武器","使用辅助剂制造飞侠武器");
        ...
        if (selectedType == 0) { //What's a stim?
            cm.sendNext("辅助剂是一种特殊的药剂，我可以在制作某些物品的过程中加入它。他让制造的物品就像是从怪物身上掉落一样。因此使用辅助剂可能使道具属性更好或者更坏。当然,有可能会失败.")
            cm.dispose();
        }
