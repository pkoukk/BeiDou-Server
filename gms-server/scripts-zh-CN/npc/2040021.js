...
function start() {
    cm.getPlayer().setCS(true);
        ...
        var options = new Array("什么是辅助剂?", "做一双战士鞋子", "做一双弓箭手鞋子", "做一双法师鞋子", "做一双飞侠鞋子",
                "做一双战士鞋子使用辅助剂", "做一双弓箭手鞋子使用辅助剂", "做一双法师鞋子使用辅助剂", "做一双飞侠鞋子使用辅助剂");
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (selectedType == 0) { // what is stim
            cm.sendNext("辅助剂是一种特殊的药水，我可以加入到创建某些项目的进程。它给它统计中，就好像从一个怪物下降。然而，它可能有没有变化，而且也有可能为项低于平均水平。还有没有得到任何项目使用刺激的时候，所以请明智的选择有10％的机会。");
            cm.dispose();
        } else if (selectedType == 1){ //warrior shoe
            selStr = "很好，那么你想做哪一个？#b";
            shoes = new Array ("#z1072003##k - 战士 等级 30#b", "#z1072039##k - 战士 等级 30#b", "#z1072040##k - 战士 等级 30#b", "#z1072041##k - 战士 等级 30#b",
                    "#z1072002##k - 战士 等级 35#b", "#z1072112##k - 战士 等级 35#b", "#z1072113##k - 战士 等级 35#b",
                    "#z1072000##k - 战士 等级 40#b", "#z1072126##k - 战士 等级 40#b", "#z1072127##k - 战士 等级 40#b",
                    "#z1072132##k - 战士 等级 50#b", "#z1072133##k - 战士 等级 50#b", "#z1072134##k - 战士 等级 50#b", "#z1072135##k - 战士 等级 50#b");
        } else if (selectedType == 2){ //bowman shoe
            selStr = "很好，那么你想做哪一个？#b";
            shoes = new Array ("#z1072079##k - 弓箭手 等级 30#b", "#z1072080##k - 弓箭手 等级 30#b", "#z1072081##k - 弓箭手 等级 30#b", "#z1072082##k - 弓箭手 等级 30#b", "#z1072083##k - 弓箭手 等级 30#b",
                    "#z1072101##k - 弓箭手 等级 35#b", "#z1072102##k - 弓箭手 等级 35#b", "#z1072103##k - 弓箭手 等级 35#b",
                    "#z1072118##k - 弓箭手 等级 40#b", "#z1072119##k - 弓箭手 等级 40#b", "#z1072120##k - 弓箭手 等级 40#b", "#z1072121##k - 弓箭手 等级 40#b",
                    "#z1072122##k - 弓箭手 等级 50#b", "#z1072123##k - 弓箭手 等级 50#b", "#z1072124##k - 弓箭手 等级 50#b", "#z1072125##k - 弓箭手 等级 50#b");
        } else if (selectedType == 3){ //magician shoe
            selStr = "很好，那么你想做哪一个？#b";
            shoes = new Array ("#z1072075##k - 法师 等级 30#b", "#z1072076##k - 法师 等级 30#b", "#z1072077##k - 法师 等级 30#b", "#z1072078##k - 法师 等级 30#b",
                    "#z1072089##k - 法师 等级 35#b", "#z1072090##k - 法师 等级 35#b", "#z1072091##k - 法师 等级 35#b",
                    "#z1072114##k - 法师 等级 40#b", "#z1072115##k - 法师 等级 40#b", "#z1072116##k - 法师 等级 40#b", "#z1072117##k - 法师 等级 40#b",
                    "#z1072140##k - 法师 等级 50#b", "#z1072141##k - 法师 等级 50#b", "#z1072142##k - 法师 等级 50#b", "#z1072143##k - 法师 等级 50#b");
        } else if (selectedType == 4){ //thief shoe
            selStr = "很好，那么你想做哪一个？#b";
            shoes = new Array ("#z1072032##k - 飞侠 等级 30#b", "#z1072033##k - 飞侠 等级 30#b", "#z1072035##k - 飞侠 等级 30#b", "#z1072036##k - 飞侠 等级 30#b",
                    "#z1072104##k - 飞侠 等级 35#b", "#z1072105##k - 飞侠 等级 35#b", "#z1072106##k - 飞侠 等级 35#b",
                    "#z1072107##k - 飞侠 等级 40#b", "#z1072108##k - 飞侠 等级 40#b", "#z1072109##k - 飞侠 等级 40#b", "#z1072110##k - 飞侠 等级 40#b",
                    "#z1072128##k - 飞侠 等级 50#b", "#z1072130##k - 飞侠 等级 50#b", "#z1072129##k - 飞侠 等级 50#b", "#z1072131##k - 飞侠 等级 50#b");
        }	
        if (selectedType != 0) {
        ...
        if (!complete)
            ...
            if (mats instanceof Array) {
                for (var i = 0; i < mats.length; i++){
                    cm.gainItem(mats[i], -matQty[i]);//扣除对应物品，数量
                }
            } else
            ...
            if (stimulator){ //check for stimulator
                ...
                if (deleted != 0) {
                    ...
                    cm.sendOk("不幸的是，辅助剂...抵触你的鞋子。我很抱歉是我的疏失.....");
                }
            } else  {
                cm.gainItem(item, 1);
                cm.sendOk("完成。善待你的鞋子，免得你使鞋子坏掉.");
