...
function action(mode, type, selection) {
	if(mode == -1) {
		...
		if(status == 0) {
			...
			var job = cm.getJobId();
			var aaa = false;
			var text = "你已达到"+relevel+"级，可以消耗黄金枫叶"+cost+"个更换职业，\r\n#e#d更换职业后等级不变，可跨职业学技能#k#n。\r\n"
			...
			if(aaa) {
				...
				cm.sendOk("我可以为你更换职业，#e#d等级不变，可跨职业学技能#k#n。\r\n如果你想要更换职业，需要#r等级"+relevela+"#k级，#r黄金枫叶"+ptcost+"个#k。\r\n注意：如果你是骑士团则需要#r等级"+relevelb+"#k级，#r黄金枫叶"+qscost+"个#k。\r\n");
				cm.dispose();
			}
		} else if (status == 1) {
				selecta = selection;
		cm.sendYesNo("现在可以为你更换职业，注意#e#d等级不变#k#n。\r\n请确认是否要更换职业？");
