...
public class PacketCreator {
    ...
    public static Packet getAuthSuccess(Client c) {
        ...
        p.writeBool((GameConfig.getServerBoolean("use_enforce_admin_account") || canFly) && c.getGMLevel() > 1); // thanks
                                                                                                                 // Steve(kaito1410)
                                                                                                                 // for
                                                                                                                 // pointing
                                                                                                                 // the
                                                                                                                 ...
                                                                                                                 // boolean
                                                                                                                 // here
        p.writeByte(((GameConfig.getServerBoolean("use_enforce_admin_account") || canFly) && c.getGMLevel() > 1) ? 0x80
        ...
        p.writeByte(GameConfig.getServerBoolean("enable_pin") && !c.canBypassPin() ? 0 : 1); // 0 = Pin-System Enabled,
                                                                                             // 1 = Disabled
